...
{
    return GetBoolArg("-testnet", false) ? 8877 : 8899;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop testcoin server (and possibly override the detachdb config value).");
