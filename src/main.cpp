...
unsigned int nTargetSpacing = 1 * 10; // 60 second blocks
unsigned int nStakeMinAge = 10 * 60; // Min Stake: 10 min
unsigned int nStakeMaxAge = -1;          // Max Stake: Unlimited
unsigned int nModifierInterval = 2 * 60; // Time before new modifier is computed

int nCoinbaseMaturity = 10; // 50 Blocks to mature
...
{nInterval = nTargetTimespan / nTargetSpacing ;} // 2 min
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "21.11.2014 testcoin";
        CTransaction txNew;
        txNew.nTime = 1416654286;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xcd5ae84a5da217e766205ec0df0e916a253b9571084a7a8b158cf03ab7caa5b9"));
        block.print();
